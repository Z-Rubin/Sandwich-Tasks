...

{
    public class DataGridViewProgressColumn : DataGridViewImageColumn
    {
        ...
        {
            if (CellTemplate is DataGridViewProgressCell progressCell)
            {
                progressCell.LargestTotal = LargestTotal;
            }
        }
    }
    ...
    {
        public float LargestTotal { get; set; } = 10000;
        ...
        protected override void Paint(System.Drawing.Graphics g, System.Drawing.Rectangle clipBounds, System.Drawing.Rectangle cellBounds, int rowIndex, DataGridViewElementStates cellState, object value, object formattedValue, string errorText, DataGridViewCellStyle cellStyle, DataGridViewAdvancedBorderStyle advancedBorderStyle, DataGridViewPaintParts paintParts)
        {
            try
            {
                ...
                float percentage = (float)progressVal / LargestTotal; // Need to convert to float before division; otherwise C# returns int which is 0 for anything but 100%.
